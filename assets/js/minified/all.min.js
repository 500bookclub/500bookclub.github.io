...
document.addEventListener("DOMContentLoaded",()=>{var o=document.querySelector("#docId");try{switch(o.classList[0]){case"c_activate":var t=getQueryParam("activateToken");t||(windows.csystem.showError("Activation Code not found."),window.location.href=window.location.href.split("activate")[0]),fetch(window.site.API+"/api/noauth/activate?activateToken="+t,{method:"GET"}).then(async o=>{hideLoading();let t={};try{t=await o.json()}catch(o){}var e;o.ok?(e=t.Code,window.location.href=window.location.href.split("activate")[0]+"passwd?Code="+e):500===o.status?window.csystem.unknownError():Object.keys(t).map(o=>{o=t[o];try{window.csystem.showError(o)}catch(o){}})}).catch(o=>{hideLoading(),window.csystem.failedToConnect()});break;case"passwd":case"forgotPassword":break;case"githubLogin":var e=getQueryParam("code");e||(window.csystem.showError("Github code not found."),window.location.href=window.location.href.split("github_login")[0]),fetch(window.site.API+"/api/auth/social/github?Code="+e,{method:"GET"}).then(async o=>{hideLoading();let t={};try{t=await o.json()}catch(o){}o.ok?(window.csystem.showSuccess("Log in successful"),window.csystem.setToken(t),window.location.href=window.csystem.getlastWinLocation()):500===o.status?window.csystem.showError("An unknown error occured."):Object.keys(t).map(o=>{o=t[o];try{window.csystem.showError(o)}catch(o){window.location.href=window.csystem.getlastWinLocation()}})}).catch(o=>{hideLoading(),window.csystem.failedToConnect()});break;case"linkedinLogin":var n=getQueryParam("code");n||(window.csystem.showError("LinkedIn code not found."),window.location.href=window.location.href.split("github_login")[0]),fetch(window.site.API+`/api/auth/social/linkedin?Code=${n}&redirect_uri=`+encodeURIComponent(window.csystem.baseUrl+"/linkedin_login"),{method:"GET"}).then(async o=>{hideLoading();let t={};try{t=await o.json()}catch(o){}o.ok?(window.csystem.showSuccess("Log in successful"),window.csystem.setToken(t),window.location.href=window.csystem.getlastWinLocation()):500===o.status?window.csystem.showError("An unknown error occured."):Object.keys(t).map(o=>{o=t[o];try{window.csystem.showError(o)}catch(o){window.location.href=window.csystem.getlastWinLocation()}})}).catch(o=>{hideLoading(),window.csystem.failedToConnect()})}}catch(o){console.error(o)}});
